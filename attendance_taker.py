...
class Face_Recognizer:
    ...
    def attendance(self, name):
        ...
        if existing_entry:
            ...
            all_attendance_today.append(f"{name} at {current_time}")
    ...
    def run(self):
        ...
        if all_attendance_today:
            full_list = '\n'.join(all_attendance_today)
            send_email("Today’s Attendance", full_list, datetime.datetime.now().strftime('%Y-%m-%d'))
